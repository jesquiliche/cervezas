...
export interface ApiCervezaCerveza extends Schema.CollectionType {
  ...
  attributes: {
    ...
    color: Attribute.Relation<
      ...
      'api::color.color'
    >;
    graduacion: Attribute.Relation<
      'api::cerveza.cerveza',
      'manyToOne',
      'api::graduacion.graduacion'
    >;
    ...
    envase: Attribute.Enumeration<['Lata', 'Botella']>;
...
export interface ApiGraduacionGraduacion extends Schema.CollectionType {
...
export interface ApiPaisPais extends Schema.CollectionType {
  ...
  attributes: {
    ...
    updatedAt: Attribute.DateTime;
    publishedAt: Attribute.DateTime;
    createdBy: Attribute.Relation<'api::pais.pais', 'oneToOne', 'admin::user'> &
      Attribute.Private;
    updatedBy: Attribute.Relation<'api::pais.pais', 'oneToOne', 'admin::user'> &
      Attribute.Private;
  };
}
...
declare module '@strapi/types' {
  export module Shared {
    export interface ContentTypes {
      ...
      'api::graduacion.graduacion': ApiGraduacionGraduacion;
